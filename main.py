...
if __name__ == '__main__':
    ...
    blocklist_level2 = [
        ...
        Block(450, 200, 10, 150, colors['WHITE'], screen),
        Block(500, 150, 10, 200, colors['WHITE'], screen),
        Block(40, 350, 420, 10, colors['WHITE'], screen),
        Block(500, 350, 410, 10, colors['WHITE'], screen),
        Block(910, 350, 10, 200, colors['WHITE'], screen),
        Block(870, 400, 10, 200, colors['WHITE'], screen),
        Block(870, 600, 80, 10, colors['WHITE'], screen),
        ...
        Block(850, 850, 100, 10, colors['WHITE'], screen),
        Block(850, 850, 10, 400, colors['WHITE'], screen),
        Block(80, 390, 390, 10, colors['WHITE'], screen),
        Block(490, 390, 390, 10, colors['WHITE'], screen),
        Block(40, 350, 10, 200, colors['WHITE'], screen),
        Block(80, 390, 10, 100, colors['WHITE'], screen),
        Block(40, 550, 80, 10, colors['WHITE'], screen),
        Block(80, 490, 100, 10, colors['WHITE'], screen),
        Block(120, 550, 10, 150, colors['WHITE'], screen),
        Block(180, 490, 10, 270, colors['WHITE'], screen),
        Block(90, 760, 100, 10, colors['WHITE'], screen),
        Block(40, 700, 90, 10, colors['WHITE'], screen),
        Block(90, 760, 10, 50, colors['WHITE'], screen),
        Block(0, 200, 210, 10, colors['WHITE'], screen),
        Block(200, 0, 10, 150, colors['WHITE'], screen),
        Block(200, 200, 250, 10, colors['WHITE'], screen),
        Block(200, 150, 300, 10, colors['WHITE'], screen),
        ...
        Block(40, 700, 90, 10, colors['WHITE'], screen),
        Block(90, 760, 10, 50, colors['WHITE'], screen),
        Block(40, 700, 10, 110, colors['WHITE'], screen),
        Block(0, 810, 50, 10, colors['WHITE'], screen),
        Block(90, 810, 100, 10, colors['WHITE'], screen),
        Block(190, 810, 10, 300, colors['WHITE'], screen),
        Block(0, 200, 210, 10, colors['WHITE'], screen),
        Block(200, 0, 10, 150, colors['WHITE'], screen),
        Block(200, 200, 250, 10, colors['WHITE'], screen),
        Block(200, 150, 300, 10, colors['WHITE'], screen),
        ...
        Block(90, 810, 100, 10, colors['WHITE'], screen),
        Block(190, 810, 10, 300, colors['WHITE'], screen),
        Block(460, 400, 10, 400, colors['WHITE'], screen),
        Block(490, 400, 10, 400, colors['WHITE'], screen),
        Block(490, 800, 100, 10, colors['WHITE'], screen),
        Block(590, 800, 10, 400, colors['WHITE'], screen),
        Block(370, 800, 100, 10, colors['WHITE'], screen),
        Block(370, 800, 10, 200, colors['WHITE'], screen),
        Block(0, 820, 190, 180, colors['GREEN'], screen),
        Block(380, 810, 210, 190, colors['GREEN'], screen),
        Block(860, 860, 140, 140, colors['GREEN'], screen)
